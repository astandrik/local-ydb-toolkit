...
const workflowSafety = [
  ...
  "Call mutating tools without confirm first. After the user explicitly approves the returned exact plan, repeat the same request with confirm=true and that response's confirmationToken.",
