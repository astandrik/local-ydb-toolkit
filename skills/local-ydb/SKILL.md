...
- For generated column tables, use `partitionByHash` only with `store: "column"` and primary key columns. Keep secondary and vector indexes on row-oriented tables.
