...
- Keep Json/JsonDocument parameter integers within JavaScript's safe-integer range. The tool rejects larger parsed integers before encoding so JSON-RPC rounding cannot silently change the value sent to YDB.
